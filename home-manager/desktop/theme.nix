{ pkgs, ... }:
{
  ...
  qt = {
    enable = true;
    platformTheme.name = "Mint-Y-Dark";
    style = {
      name = "Mint-Y-Dark";
    };
  };
  home.file.".config/cinnamon/spices/menu@cinnamon.org/0.json".text = builtins.toJSON {
    menu-custom = {
      type = "switch";
      value = true;
    };
    menu-icon = {
      ...
      value = "${pkgs.nixos-icons}/share/icons/hicolor/scalable/apps/nix-snowflake-white.svg";
    };
    menu-label = {
      type = "entry";
      value = "";
